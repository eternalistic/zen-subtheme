...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <?php if ($add_respond_js): ?>
    <!--[if lt IE 9]>
    <script src="<?php print $base_path . $path_to_subtheme; ?>/js/html5/html5shiv.js"></script>
    <script src="<?php print $base_path . $path_to_subtheme; ?>/js/html5/respond.min.js"></script>
    <![endif]-->
