...
function zen_ghp_form_alter(&$form, &$form_state, $form_id) {
  ...
  switch ($form_id)  {
    ...
    case 'search_block_form':
      ...
      $form['#attributes']['onsubmit'] = "if(this.search_block_form.value=='$searchtext'){return false; }";
    ...
    case 'search_form':
      ...
      // Button
      $form['basic']['submit'] = array('#type' => 'image_button', '#src' => base_path() . path_to_theme() . '/images/search-icon.png');
